document.addEventListener('DOMContentLoaded', function () {
    ...
    function handleRollDice() {
        ...
        if (currentPlayer === 1) {
            const newPosition = updatePosition(player1Position, player1Board, 'player1', diceRoll);
            ...
            const newPosition = updatePosition(player2Position, player2Board, 'player2', diceRoll);
        ...
        if (getCurrentPlayerPosition() === 10) {
            ...
            updateGameInfo(`🏁 ${winnerPlayer} wins reaching position 10 first with dice count: ${diceRoll}!`);
